...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_source_file = .{ .file = "bloom_bootloader.zig" }, // Updated for Zig 0.13.0
        .target = target,
        .optimize = optimize,
    });
    ...
    const spinup_mod = b.addModule("spinUP", .{
        .source_file = .{ .file = "spinUP/spinUP.zig" }, // Updated for Zig 0.13.0
        .dependencies = &.{
            .{ .name = "quantum", .module = quantum_mod },
            .{ .name = "crystal", .module = crystal_mod },
            .{ .name = "starweave", .module = starweave_mod },
    ...
    const spun_mod = b.addModule("spun", .{
        .source_file = .{ .file = "spun/spun.zig" }, // Updated for Zig 0.13.0
        .dependencies = &.{
            .{ .name = "quantum", .module = quantum_mod },
            .{ .name = "crystal", .module = crystal_mod },
            .{ .name = "starweave", .module = starweave_mod },
